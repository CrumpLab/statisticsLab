...
Data files used for the labs are all taken from open data sources. Links are provided for each lab. For convenience, all of the data files are also available here:
...
3. To see how everything would work, follow the steps in this video. You will need to download this [.zip file to your computer to get started]([download lab templates](https://github.com/CrumpLab/statisticsLab/raw/master/RstudioCloud.zip)
